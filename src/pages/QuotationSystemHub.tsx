...
const features = [
  {
    id: 'new-quotation',
    title: 'New Quotation',
    description: 'Create a new quotation with full routing sheet, BOM, subcon, and cost breakdown',
    icon: PlusCircle,
  ...
  },
  {
    ...
    description: 'View, manage, and export existing quotations',
    icon: ClipboardList,
  ...
  },
  {
    ...
    description: 'Calculate costs quickly based on time and resources',
    icon: Calculator,
    href: '/npi/quotation-system/calculator',
