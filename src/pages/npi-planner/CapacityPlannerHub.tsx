...
const tiles = [
  ...
  { id: 'tooling-status', title: 'Tooling Status', desc: 'Update per-part tooling status (Ordered starts the lead-time clock)', icon: Wrench, href: '/npi/capacity-planner/tooling-status', color: 'bg-rose-500/10 text-rose-600 border-rose-500/20' },
  ...
  { id: 'tooling', title: 'Tooling Catalog', desc: 'Reusable tool library — set up once, link to many PNs from Tooling Status', icon: Wrench, href: '/npi/capacity-planner/tooling', color: 'bg-pink-500/10 text-pink-600 border-pink-500/20' },
