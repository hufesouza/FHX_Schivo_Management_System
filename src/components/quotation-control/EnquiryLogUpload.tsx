...
interface EnquiryLogUploadProps {
  onFileProcessed: (data: ParsedEnquiryLog[]) => Promise<boolean>;
  isUploading: boolean;
}

type UploadStatus = 'idle' | 'parsing' | 'success' | 'error';

export function EnquiryLogUpload({ onFileProcessed, isUploading }: EnquiryLogUploadProps) {
    ...
    >
      ...
      {isProcessing ? (
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div>
            <p className="font-medium">Drop your Enquiry Log Excel file here</p>
          ...
          <div className="flex items-center gap-2 text-xs text-muted-foreground mt-2">
            ...
            <span>Updated_Enquiry_Log_-_Master_2025.xlsx format</span>
          </div>
        </div>
      )}
    </div>
